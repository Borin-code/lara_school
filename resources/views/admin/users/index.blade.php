        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="font-family: 'Khmer Moul', cursive;
                ...
                height: 50px;
                text-align: center;
                border-radius: 5px; width: 500px;"class="m-0">បញ្ជីអ្នកប្រើប្រាស់</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li style="font-family: 'Khmer Os SiemReap', cursive;" class="breadcrumb-item">
                <a style="color: green; margin-top: -8px;" href="index3.html" class="nav-link" href="#">ទំព័រដើម</a></li>
              <li style="font-family: 'Khmer Os SiemReap', cursive; color: darkblue;" class="breadcrumb-item active">បញ្ជីអ្នកប្រើប្រាស់</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card" style="font-family: 'Khmer Os SiemReap', cursive; font-weight: 400; color: black;">
                <div class="card-header bg-primary">
                    <h3 class="card-title">បញ្ជីអ្នកប្រើប្រាស់</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach($users as $key => $user)
                                <tr id="user-row-{{ $user->id }}">
                                    ...
                                    <td>{{ $user->address }}</td>
                                    <td>
                                        {{-- <img style="width: 50px;" src="{{ asset('storage/' . $user->avatar) }}" alt="{{ $user->name }}"> --}}

        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 style="font-family: 'Khmer Moul', cursive;
                    ...
                    height: 50px;
                    text-align: center;
                    border-radius: 5px; width: 500px;" class="m-0">តារាងកែប្រែអ្នកប្រើប្រាស់</h1>
            </div>
            <div class="col-sm-6">
...
<div class="container-fluid">
    <div class="row">
        <div class="col-9">
            <div class="card" style="font-family: 'Arial Narrow'; font-family: 'Khmer Os SiemReap', cursive;  font-weight: 400; color: blue;">
